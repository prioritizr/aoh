...
Next, we will import habitat classification data. Although such data would be automatically imported by default (using the `get_lumbierres_habitat_data()` function), here we will import example data distributed with the package.
