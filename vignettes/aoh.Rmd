...
We can now generate Area of Habitat data for the species. By default, these data will be generated using elevation data derived from [Amatulli *et al.* 2018](https://doi.org/10.1038/sdata.2018.40) and habitat data derived from [Lumbierres *et al.* 2021](https://doi.org/10.1111/cobi.13851). Similar to before, we also specify a folder to cache the downloaded datasets so that we won't need to re-downloaded again during subsequent runs.
