...
The GDAL binary library will need to be installed when using Ubuntu. For recent versions of Ubuntu (18.04 and later), this library is available through official repositories. It can be installed using the following system commands.
