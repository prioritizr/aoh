...
Global elevation and habitat classification data ([Jung *et al.*
2020](https://doi.org/10.1038/s41597-020-00599-8); [Lumbierres *et al.*
2021](https://doi.org/10.1111/cobi.13851); [Robinson *et al.*
...
please restart your computer. If the
[`aoh::is_gdal_calc_available()`](https://prioritizr.github.io/aoh/reference/is_gdal_calc_available.md)
...
with the token) and save the file, using your token in place of the
string below.
...
relevant data using:
  ...
  0.0.3.3. Available at https://github.com/prioritizr/aoh.
