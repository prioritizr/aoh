...
Import species habitat preference data obtained from the [International
...
[`rredlist::rl_habitats()`](https://docs.ropensci.org/rredlist/reference/rl_habitats.html).
