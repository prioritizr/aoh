...
#' level 2 raster dataset with IUCN habitat classes.
#'
#' @docType data
#'
#' @keywords datasets
#'
#' @name crosswalk_jung_lvl2_data
#'
#' @usage data(crosswalk_jung_lvl2_data)
#'
#' @format
#' A data frame ([tibble::tibble()]) object with
#' `r nrow(crosswalk_jung_lvl2_data)` rows and
#' `r ncol(crosswalk_jung_lvl2_data)` columns.
...
#'  (see [get_jung_lvl2_habitat_data()]).}
#' }
#'
#' @source
...
#'
#' @aliases crosswalk_jung_lvl2_data
#'
#' @examples
#' # load data
...
#'
#' # print data
#' print(crosswalk_jung_lvl2_data)
NULL
